...
typedef TMilli TestC__Timer0__precision_tag;
typedef TMilli TestC__Timer1__precision_tag;
typedef TMilli TestC__Timer2__precision_tag;
...
static void TestC__Timer0__fired(void );
# 60 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void TestC__Boot__booted(void );
# 83 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void TestC__Timer1__fired(void );
#line 83
static void TestC__Timer2__fired(void );
# 62 "/opt/tinyos-2.x/tos/interfaces/Init.nc"
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void TestC__Timer0__startPeriodic(uint32_t dt);
#line 64
static void TestC__Timer1__startPeriodic(uint32_t dt);
# 67 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void TestC__Timer2__startPeriodic(uint32_t dt);
# 12 "TestC.nc"
static inline void TestC__Boot__booted(void );



static inline void TestC__Timer0__fired(void );




static inline void TestC__Timer1__fired(void );




static inline void TestC__Timer2__fired(void );
# 42 "/opt/tinyos-2.x/tos/interfaces/GeneralIO.nc"
...
#line 78
#line 64
inline static void TestC__Timer1__startPeriodic(uint32_t dt){
#line 64
...
static inline void TestC__Timer0__fired(void )
{
  ...
  TestC__Timer1__startPeriodic(250);
}

# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void TestC__Timer2__startPeriodic(uint32_t dt){
#line 64
...
static inline void TestC__Timer1__fired(void )
{
  ...
  TestC__Timer2__startPeriodic(250);
}
...
# 83 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7e396d90){
#line 83
  switch (arg_0x7e396d90) {
#line 83
    case 0U:
#line 83
      TestC__Timer0__fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      TestC__Timer1__fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      TestC__Timer2__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7e396d90);
#line 83
      break;
#line 83
    }
...
#line 62
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void TestC__Timer0__startPeriodic(uint32_t dt){
#line 64
...
static inline void TestC__Boot__booted(void )
{
  TestC__Timer0__startPeriodic(1000);
}
...
# 75 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7e868148){
#line 75
